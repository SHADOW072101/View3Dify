...
CONFIG = {
    "image_folder": "path/to/your/images", #enter the Path to the folder containing input images
    "output_folder": "path/to/output", #enter the  Path to save output files
...
def save_reconstruction(reconstruction, model_subdir):
    ...
    try:
        ...
        mesh_file = model_subdir / "mesh.ply"
